...
| Receipts | Shows recorded PayPal order/capture identifiers and labels legacy provider records as historical; it does not invent a tax invoice or PDF receipt |

...
export default function UnauthorizedPage() {
  return (
    <AuthShell>
      <main id="main-content" className="mx-auto grid min-h-[calc(100vh-75px)] w-[min(calc(100%-40px),720px)] place-items-center py-16 text-center md:w-[min(calc(100%-64px),720px)]">
        <div>

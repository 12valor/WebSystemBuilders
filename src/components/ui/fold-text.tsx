...
export type SplitByMode = "char" | "word" | "line";
...
export function FoldText({
    ...
    const renderSegment = (
      ...
      return (
        <span
          ...
          key={key}
          style={{
            ["--fold-perspective" as string]: `${safePerspective}px`,
  ...
  useEffect(() => {
    ...
    const fromVars: gsap.TweenVars = {
      ...
      ["--fold-crease" as string]: reduceMotion ? 0 : safeCrease,
      transformOrigin: hingeConfig.origin,
      force3D: true,
    };

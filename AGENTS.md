...
The project is currently in Phase 5 while live provider verification and earlier production gates remain pending. Read [`docs/PHASE_0_PRODUCT_DEFINITION.md`](docs/PHASE_0_PRODUCT_DEFINITION.md) for confirmed product decisions and deferred production gates, [`docs/PHASE_1_DESIGN_FOUNDATION.md`](docs/PHASE_1_DESIGN_FOUNDATION.md) for approved design rules, [`docs/PHASE_2_TECHNICAL_FOUNDATION.md`](docs/PHASE_2_TECHNICAL_FOUNDATION.md) for the schema, security, and setup gates, [`docs/PHASE_3_PUBLIC_WEBSITE.md`](docs/PHASE_3_PUBLIC_WEBSITE.md) for public-route gates, [`docs/PHASE_4_SYSTEMS_CATALOG.md`](docs/PHASE_4_SYSTEMS_CATALOG.md) for catalog completion and provider gaps, and [`docs/PHASE_5_ADMIN_DASHBOARD.md`](docs/PHASE_5_ADMIN_DASHBOARD.md) for the active administrator checklist. Do not present proposed or open items as approved policy.

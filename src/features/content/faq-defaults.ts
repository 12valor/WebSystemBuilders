export const defaultFaqItems = [
  ...
  },
  {
    ...
    answer: "Ready-made systems may use a fixed price or a visible starting price. Custom development uses a quotation. PHP is the canonical catalog and default settlement currency; localized display amounts are estimates and must not silently change the authoritative checkout price.",
    category: "Pricing",
  },
  {

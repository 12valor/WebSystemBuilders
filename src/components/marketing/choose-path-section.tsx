...
export function ChoosePathSection() {
  return (
    <section className="relative border-y border-slate-200/80 bg-[#FAFAFC] py-14 sm:py-16 md:py-20">
      <div className="mx-auto w-[min(calc(100%-32px),1280px)] md:w-[min(calc(100%-64px),1280px)]">
        {/* Section Header */}
        <div className="mb-8 max-w-2xl md:mb-10">
          <h2 className="font-heading text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl lg:text-5xl leading-[1.1]">
        ...
        <div className="grid grid-cols-1 items-stretch gap-6 md:grid-cols-2">
          ...
          <div className="group flex h-full flex-col justify-between rounded-2xl border border-blue-200/70 bg-[#F4F8FF] p-6 sm:p-8 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:border-blue-300 hover:shadow-md motion-reduce:transform-none motion-reduce:transition-none">
            <div>
              ...
              <h3 className="mt-5 font-heading text-xl sm:text-2xl font-bold text-slate-900 tracking-tight">
              ...
              <ul className="mt-6 space-y-3 border-t border-blue-200/60 pt-5">
                <li className="flex items-center gap-2.5 text-sm text-slate-800 font-medium">
            ...
            <div className="mt-8">
              <Link
                href="/for-students"
                className="group/btn inline-flex h-11 w-full items-center justify-center gap-2 rounded-full bg-blue-600 px-6 text-sm font-semibold text-white shadow-xs transition-colors duration-200 hover:bg-blue-700 motion-reduce:transition-none"
              >
          ...
          <div className="group flex h-full flex-col justify-between rounded-2xl border border-slate-200/90 bg-white p-6 sm:p-8 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:border-slate-300 hover:shadow-md motion-reduce:transform-none motion-reduce:transition-none">
            <div>
            ...
            <div className="mt-8">
              <Link
                href="/for-business"
                className="group/btn inline-flex h-11 w-full items-center justify-center gap-2 rounded-full bg-slate-900 px-6 text-sm font-semibold text-white shadow-xs transition-colors duration-200 hover:bg-slate-800 motion-reduce:transition-none"
              >

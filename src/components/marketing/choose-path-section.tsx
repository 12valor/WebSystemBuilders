  ...
  return (
    <section className="relative border-y border-slate-200/80 bg-[#FAFAFC] py-12 sm:py-16 md:py-20">
      <div className="mx-auto w-[min(calc(100%-32px),1280px)] md:w-[min(calc(100%-64px),1280px)]">
        {/* Section Header */}
        <div className="mb-7 max-w-2xl sm:mb-8 md:mb-10">
        ...
        <div className="grid grid-cols-1 items-stretch gap-5 sm:gap-6 md:grid-cols-2">
          ...
          <div className="group flex h-full flex-col justify-between rounded-2xl border border-blue-200/70 bg-[#F4F8FF] p-5 sm:p-8 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:border-blue-300 hover:shadow-md motion-reduce:transform-none motion-reduce:transition-none">
            <div>
          ...
          <div className="group flex h-full flex-col justify-between rounded-2xl border border-slate-200/90 bg-white p-5 sm:p-8 shadow-xs transition-all duration-200 hover:-translate-y-1 hover:border-slate-300 hover:shadow-md motion-reduce:transform-none motion-reduce:transition-none">
            <div>

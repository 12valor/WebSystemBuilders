...
export function SiteFooter() {
  return (
    <footer
      ...
      className="relative overflow-hidden bg-[#07080A] text-[#F5F5F7] pt-20 pb-12 sm:pt-28 sm:pb-14 border-t border-white/[0.08]"
    >
      ...
      >
        ...
        <div className="absolute -bottom-16 left-[28%] h-[380px] w-[540px] -translate-x-1/2 rounded-full bg-[#1E3A8A]/30 blur-[130px]" />
        {/* Muted violet / magenta aura on right */}
        <div className="absolute -bottom-12 right-[22%] h-[360px] w-[480px] translate-x-1/2 rounded-full bg-[#4C1D95]/25 blur-[140px]" />
        {/* Subtle center ambient floor fill */}
        <div className="absolute bottom-0 left-1/2 h-[220px] w-[720px] -translate-x-1/2 rounded-full bg-[#2563EB]/10 blur-[110px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto w-[min(calc(100%-32px),1340px)] md:w-[min(calc(100%-64px),1340px)]">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 pb-12 sm:pb-16 border-b border-white/[0.08]">
          {/* Left: Direct Contact */}
        ...
        <div className="py-12 sm:py-16 md:py-20 select-none overflow-hidden" aria-hidden="true">
        ...
        {/* BOTTOM UTILITY BAR */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 text-xs sm:text-[13px] text-[#71717A] border-t border-white/[0.06]">
          {/* Copyright */}

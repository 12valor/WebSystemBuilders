        ...
        <section id="orders" className="border-b border-slate-200/80 pb-10 space-y-6">
          ...
          {data.orders.length === 0 ? (
            <div className="rounded-2xl border border-slate-200/90 bg-white p-12 text-center shadow-xs">
              ...
              <Link
                href="/systems"
                className="blue-button mt-6 inline-flex min-h-11 items-center justify-center gap-2 bg-[#2563EB] px-5 text-xs font-semibold text-white"
              >
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    ...
                    {order.delivery_available && (
                      <form action={openPortalDownload.bind(null, order.order_id)}>
                        <button
                          type="submit"
                          className="blue-button inline-flex min-h-10 items-center justify-center gap-2 bg-[#2563EB] px-4 text-xs font-semibold text-white"
                        >

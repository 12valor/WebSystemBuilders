...
function ProofIllustration({ variant }: { variant: ProofTopicId }) {
  return (
    <svg aria-hidden="true" viewBox="0 0 760 560" className="size-full" fill="none">
      ...
      <circle cx="626" cy="102" r="112" fill="#DBEAFE" />
      ...
      {variant === "source" && (
        <g>
          ...
          <circle cx="128" cy="124" r="8" fill="#60A5FA" />
          ...
          <path d="M336 215H448M336 252H420M336 289H458M336 326H404" stroke="#2563EB" strokeWidth="12" strokeLinecap="round" />
          <path d="M473 326H560" stroke="#1D4ED8" strokeWidth="9" strokeLinecap="round" strokeDasharray="10 13" />
          <path d="M544 307L566 326L544 345" stroke="#1D4ED8" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" />
          <g transform="translate(530 280)">
            <path d="M0 52L84 9L168 52L84 95L0 52Z" fill="#EFF6FF" stroke="#0F172A" strokeWidth="7" strokeLinejoin="round" />
            ...
            <path d="M65 42L104 62" stroke="#2563EB" strokeWidth="10" strokeLinecap="round" />
          </g>
        </g>
      )}
      ...
      {variant === "payment" && (
        <g>
          ...
          <path d="M344 274H425" stroke="#1D4ED8" strokeWidth="9" strokeLinecap="round" strokeDasharray="10 13" />
          <path d="M409 255L431 274L409 293" stroke="#1D4ED8" strokeWidth="9" strokeLinecap="round" strokeLinejoin="round" />
      ...
      {variant === "support" && (
        <g>
          ...
          <circle cx="104" cy="149" r="8" fill="#2563EB" />
          <circle cx="131" cy="149" r="8" fill="#93C5FD" />
          <circle cx="294" cy="292" r="74" fill="#DBEAFE" />
          <path d="M255 310L321 244M270 238L328 296" stroke="#2563EB" strokeWidth="18" strokeLinecap="round" />
          ...
          <g transform="translate(490 76)">
            ...
            <text x="93" y="124" textAnchor="middle" fill="#2563EB" fontFamily="ui-sans-serif, system-ui, sans-serif" fontSize="58" fontWeight="800">30</text>
          </g>
          <g transform="translate(510 342)">
            ...
            <path d="M34 36H142M34 66H112" stroke="#2563EB" strokeWidth="10" strokeLinecap="round" />
          </g>
        </g>
      )}
      ...
      {variant === "details" && (
        <g>
          ...
          <rect x="112" y="118" width="126" height="16" rx="8" fill="#2563EB" />
          <rect x="112" y="156" width="214" height="11" rx="5.5" fill="#DBEAFE" />
          <rect x="112" y="214" width="28" height="28" rx="7" fill="#EFF6FF" stroke="#2563EB" strokeWidth="5" />
          <path d="M119 228L126 235L138 220" stroke="#2563EB" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M164 221H340M164 240H292" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" />
          <rect x="112" y="286" width="28" height="28" rx="7" fill="#EFF6FF" stroke="#2563EB" strokeWidth="5" />
          <path d="M119 300L126 307L138 292" stroke="#2563EB" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M164 293H322M164 312H278" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" />
          <rect x="112" y="358" width="28" height="28" rx="7" fill="#EFF6FF" stroke="#2563EB" strokeWidth="5" />
          <path d="M119 372L126 379L138 364" stroke="#2563EB" strokeWidth="5" strokeLinecap="round" strokeLinejoin="round" />
          <path d="M164 365H306M164 384H252" stroke="#0F172A" strokeWidth="8" strokeLinecap="round" />
          <g transform="translate(454 132)">
            <ellipse cx="112" cy="36" rx="112" ry="36" fill="#BFDBFE" stroke="#0F172A" strokeWidth="7" />
            ...
            <ellipse cx="112" cy="36" rx="66" ry="16" fill="#2563EB" />
          </g>
        </g>
      )}
    </svg>
...
export function WhyChooseUsSection() {
  ...
  return (
    <section aria-labelledby="confidence-title" className="relative overflow-hidden border-y border-slate-200 bg-[#F3F6FB] py-20 font-sans text-slate-950 sm:py-24 lg:py-28">
      <div className="relative mx-auto grid w-[min(calc(100%-32px),1280px)] items-center gap-12 md:w-[min(calc(100%-64px),1280px)] lg:grid-cols-[1.08fr_0.92fr] lg:gap-16">
        ...
        <div>
          <p className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-white/80 px-3.5 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-blue-700">
          ...
          <div id="purchase-proof-details" aria-live="polite" className="mt-7">
            <p className="text-xs font-extrabold uppercase tracking-[0.14em] text-blue-700">{activeTopic.eyebrow}</p>
            ...
            <div className="mt-5 space-y-3">
              {activeTopic.facts.slice(0, 2).map(([title, description], index) => (
                <div key={title} className="flex items-start gap-3 rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-[0_12px_30px_-28px_rgba(15,23,42,0.4)]">
                  <span className="grid size-10 shrink-0 place-items-center rounded-xl border border-blue-200 bg-blue-50 text-sm font-bold text-blue-700">

...
const required = [
  ...
  ["lemonsqueezy_api_key", "LEMON_SQUEEZY_API_KEY", (value) => value.length >= 10],
  ["lemonsqueezy_store_id", "LEMON_SQUEEZY_STORE_ID", (value) => value.length >= 1],
  ["lemonsqueezy_webhook_secret", "LEMON_SQUEEZY_WEBHOOK_SECRET", (value) => value.length >= 8],
